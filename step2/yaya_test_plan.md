# Yaya Test Plan for Workflow Transformations

This document describes the YAML transformations needed for the workspace migration, serving as test cases and requirements for extending yaya.
...
ruamel.yaml's `CommentedMap` tracks comments, and yaya should maintain them through transformations.
