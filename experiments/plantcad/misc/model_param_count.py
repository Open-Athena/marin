...
if __name__ == "__main__":
    ...
    print(
        f"\nNano config with genomic vocab: "
        f"{count_parameters_exact(nano_config, genomic_vocab_size)['actual_params_millions']:.1f}M"
    )
    print(
        f"10M config with genomic vocab: "
        f"{count_parameters_exact(config_10m, genomic_vocab_size)['actual_params_millions']:.1f}M"
    )
    print(
        f"30M config with genomic vocab: "
        f"{count_parameters_exact(config_30m, genomic_vocab_size)['actual_params_millions']:.1f}M"
    )
    print(
        f"100M config with genomic vocab: "
        f"{count_parameters_exact(config_100m, genomic_vocab_size)['actual_params_millions']:.1f}M"
    )
